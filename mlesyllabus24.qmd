...
Week 1, Aug 21 --  Likelihood Theory and ML Estimation
...
-  J. Scott Long.  1997. *Regression Models for Categorical and Limited Dependent Variables}. Chapters 1-2.
 ...
 Week 2, Aug 28 --Binary Dependent Variables I - probit/logit, QI
...
<!-- -  @kingajps00clarify -->
 ...
 Week 3, Sept 4 -- Binary Dependent Variables II - variants (scobit, ordered, RE)
...
-  @zorn2005solution
 ...
 Week 4, Sept 11 -- Hazards I (discrete)
...
-  @carter2010back
 ...
 Week 5, Sept 18 -- Assumptions and Specification I - heteroskedasticity, iid
...
-  @clarknordstromjop05
 ...
 Week 6, Sept 25 -- Assumptions and Specification II - interactions, variables, measurement of $y$
...
-  @brambor2006understanding
 ...
 Week 8, Oct 9 -- Choice Models I (Unordered Dependent Variables) - MNL, MNP, CL (IIA)
...
-  @franklinkosaki
 ...
 Week 10, Oct 23  -- Event Count Models I - poisson, over/under dispersion
...
-  @clarkstrategic
 ...
 Week 12, Nov 6 -- Hazard Models II - parametric, semi-parametric models
...
-  @boxapsr
 ...
 Week 13, Nov 13 -- Hazard Models III - parametric models, special topics
