...
Please note that all written assignments must be submitted as PDFs either compiled in *LaTeX* or in {{< fa brands r-project >}} markdown (Quarto).
...
Week 1, Aug 24 --  Likelihood Theory and ML Estimation
...
-  J. Scott Long.  1997. *Regression Models for Categorical and Limited Dependent Variables}. Chapters 1-2.
 ...
 Week 2, Aug 31 --Binary Dependent Variables I - probit/logit, QI
...
<!-- -  @kingajps00clarify -->
 ...
 Week 3, Sept 7 -- Binary Dependent Variables II - variants (scobit, ordered, RE)
...
-  @zorn2005solution
 ...
 Week 4, Sept 14 -- Hazards I (discrete)
...
-  @carter2010back
 ...
 Week 5, Sept 21 -- Assumptions and Specification I - heteroskedasticity, iid
...
-  @clarknordstromjop05
 ...
 Week 6, Sept 28 -- Assumptions and Specification II - interactions, variables, measurement of $y$
...
-  @brambor2006understanding
 ...
 Week 7, Oct 5 -- No class, Yom Kippur 

 Week 8, Oct 12 -- Choice Models I (Unordered Dependent Variables) - MNL, MNP, CL (IIA)
...
-  @zorniia
 ...
 Week 9, Oct 19-- Choice Models II (Unordered Dependent Variables continued, and systems of eqs, ordered)
...
-  @franklinkosaki
 ...
 Week 10, Oct 26  -- Event Count Models I - poisson, over/under dispersion
...
Week 11, Nov 2 -- Event Count Models II - negative binomial, zero-altered
...
-  @clarkstrategic
 ...
 Week 12, Nov 9 -- Hazard Models II - parametric, semi-parametric models
...
-  @boxapsr
 ...
 Week 13, Nov 16 -- Hazard Models III - parametric models, special topics
...
-  @jcrspecialissuezorn
 ...
 Week 15, Dec 7  -- Censored/Truncated Variables, Samples - selection models
