...
## Assumptions
 ...
 - the probability of an event, $\lambda$, in any given period, $d$, is constant across $d$ (i.e. \alert{constant rate of arrival})
...
Again, emphasizing two assumptions:
  ...
  - event independence \alert{within spell, $d$}.  
...
All the usual techniques apply (at-mean; average; simulated): 
  ...
  - $exp(\beta_k)$ is the \alert{incident rate ratio (IRR)} - similar to odds ratios in the logistic model.
